...
📺 **Watch:** the [`demo` release](../../releases/tag/demo) assets — `ProofAgent0G_master_16x9.mp4` (the ~2-min submission cut), `ProofAgent0G_hero_9x16.mp4` (a ~24s vertical short), and `thumbnail.png` (the title-card hero image).
...
- MandateRegistry `0x675FF5…D345` · V3 `0xC24A32…02BD2` (both live, have code)
