...
SCENES = [
 ...
 dict(id="03_trio", frames=lambda:[R.title_card("The verification trio","three independent axes - each provable on its own",
      chips=[("VERIFY CODE","clean-room, open, MIT",R.CYAN),("BOUND SPEND","the on-chain mandate",R.GOLD),("PROVE SETTLE","the independent verifier",R.GREEN)],
 ...
 dict(id="10_rigor", frames=lambda:[R.rigor_card(cap="cap + gas-floor + net-worth-floor  -  clean-room  -  MIT")], min=6.0,
